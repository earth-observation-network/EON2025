...
# robustes Speichern von kable-Tabellen als eigenständige HTML-Datei
safe_save_kable <- function(tab, file_html, self_contained = TRUE, ...) {
  ...
  out_dir <- dirname(file_html)
  if (!dir.exists(out_dir)) dir.create(out_dir, recursive = TRUE, showWarnings = FALSE)

  # innerhalb des Zielverzeichnisses speichern; kableExtra sieht nur den Basisnamen
  if (!requireNamespace("withr", quietly = TRUE)) {
    install.packages("withr")  # einmalig, falls nicht installiert
  }
