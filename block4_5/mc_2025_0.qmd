...
format:
  html:
    title-block-banner: ../images/mc3.png
    toc: true
...
```{=html}
<iframe width="780" height="780" src="swiss_model7.html" title="Interpolation"></iframe>
```
...
Download the
[exercises repository](https://github.com/gisma-courses/eon2024-mc/blob/master/Archiv_EON2024_Interpol.zip)
